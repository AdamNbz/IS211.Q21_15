...
BEGIN
    ...
    -- 3. CHÈN DỮ LIỆU: NHANVIEN (Sửa lỗi logic phân bổ chức vụ)
    FOR v_i IN v_emp_start..v_emp_end LOOP
            ...
            VALUES (
                       ...
                       -- FIX: Đảm bảo 40 nhân viên đầu tiên của dải luôn là Quản lý kho
    ...
    WHILE v_total_details_inserted < v_target_details LOOP
            ...
            -- FIX: Loại bỏ nhân viên quản lý kho, chỉ lấy ngẫu nhiên nhân viên bán hàng trong dải hợp lệ
